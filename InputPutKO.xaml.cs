...
namespace Pricer_v5
{
    ...
    /// </summary>
    public partial class InputPutKO : Window
    {
        public InputPutKO()
        {
            InitializeComponent();
        ...
        private async void DisplayData()
        {
                ...
                await Task.Run(() =>
                {
                    for (int i = 0; i < 100000; i++)
                    {
                        if (i % 1000 == 0)
                        {
                            ...
                            if (cal.BarriereReachPutKO(L, traji) == true)
                            {
                                Prime = Prime + 0.0m;
                            }
                            else
                        ...
                        else
                        {
                            ...
                            if (cal.BarriereReachPutKO(L, traj) == true)
                            {
                                Prime = Prime + 0.0m;
                            }
                            else
            ...
            // PLOT PAYOFF
            var point2 = cal.PlotPayoff(S, K, Prime / 100000m, "PutKO", L);
            ...
            decimal PrimeFa = Math.Round(cal.PutKO(S, r, v, Tfa, K, L), 5);
            FAInp.Text = PrimeFa.ToString();
            MCInp.Text = Prime.ToString();
            DeltaInp.Text = Math.Round(cal.DeltaKOFDM(S, r, v, Tfa, K, L, "Put"), 5).ToString();
            GammaInp.Text = Math.Round(cal.GammaKOFDM(S, r, v, Tfa, K, L, "Put"), 5).ToString();
            VegaInp.Text = Math.Round(cal.VegaKOFDM(S, r, v, Tfa, K, L, "Put"), 5).ToString();
            ThetaInp.Text = Math.Round(cal.ThetaKOFDM(S, r, v, Tfa, K, L, "Put"), 5).ToString();
            RhoInp.Text = Math.Round(cal.RhoKOFDM(S, r, v, Tfa, K, L, "Put"), 5).ToString();
        }
