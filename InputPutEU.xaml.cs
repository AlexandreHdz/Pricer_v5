...
namespace Pricer_v5
{
    ...
    public partial class InputPutEU : Window
    {
        ...
        private async void DisplayData()
        {
            ...
            double Prix = cal.put_price(S, K, r, v, Tfa);
            ...
            DeltaInp.Text = Math.Round(cal.put_delta(S, r, v, Tfa, K), 5).ToString();
            GammaInp.Text = Math.Round(cal.put_gamma(S, r, v, Tfa, K), 5).ToString();
            VegaInp.Text = Math.Round(cal.put_vega(S, r, v, Tfa, K), 5).ToString();
            ThetaInp.Text = Math.Round(cal.put_theta(S, r, v, Tfa, K), 5).ToString();
            RhoInp.Text = Math.Round(cal.put_rho(S, r, v, Tfa, K), 5).ToString();
        }
